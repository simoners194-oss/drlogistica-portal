...
const en = {
  ...
  "gt.turnoTroppoLungo":
    "The shift spans more than 24 hours: check the times (a time earlier than the previous step counts as the next day).",
  ...
  "login.pinDimenticato": "Forgot your PIN? Change it via email",
  "cp.title": "Change PIN",
  "cp.sub1": "Enter your employee code: we'll email a verification code to the address on file.",
  "cp.sub2": "Enter the 6-digit code from the email and choose your new PIN.",
  "cp.mandami": "Send me the code",
  "cp.invio": "Please wait…",
  "cp.inviata":
    "If everything checks out, the code is on its way to {email}. It's valid for 15 minutes — check spam too.",
  "cp.forse":
    "If the code exists and has an email on file, the verification code is on its way. It's valid for 15 minutes.",
  "cp.otpPlaceholder": "Verification code (6 digits)",
  "cp.pinNuovo": "New PIN (4-8 digits)",
  "cp.pinRipeti": "Repeat new PIN",
  "cp.pinDiversi": "The two PINs don't match.",
  "cp.cambia": "Change PIN",
  "cp.rimanda": "Wrong code or nothing arrived? Start over",
  "cp.tornaLogin": "Back to sign in",
  "cp.nota": "No email on file? Ask the office to register it, then try again.",
  "cp.fatto": "PIN changed — sign in with the new one.",
  "cp.errGenerico": "Something went wrong. Try again.",
  "login.hero":
  ...
  "common.print": "Print",
  "common.printTip": "Prints this summary only (menu, filters and buttons stay out)",
  "common.open": "open",
  ...
  "presenze.saving": "Saving…",
  "presenze.quickMyHours": "My hours",
  "presenze.quickMyHoursDesc": "Shifts of the month and corrections",
  "presenze.quickManual": "Manual",
  "presenze.quickManualDesc": "How the portal works",
  "presenze.quickPin": "Change PIN",
  "presenze.quickPinDesc": "With the code sent by e-mail",
  ...
  "gt.scarta": "Dismiss",
  "gt.scartataOk": "Anomaly dismissed.",
  ...
  "fin.tabFlussi": "Cash flow",
  "fin.tabStipendi": "Payroll",
  "fin.tabFiscale": "Tax",
  "fis.titolo": "Tax schedule",
  "fis.desc":
    "Sabrina's tax schedule, editable right here: deadlines, Payable and Paid pivots, CSV export for each view. The 'Costo fiscale' rows in Cash flow read this same data. The Excel import (Cash flow panel) stays for the transition: it replaces FILE rows and keeps the ones created or edited on the portal.",
  "fis.fonte": "Last imported file:",
  "fis.vistaScadenze": "Deadlines",
  "fis.vistaDaPagare": "Payable",
  "fis.vistaPagato": "Paid",
  "fis.cercaPh": "Search item, detail, notes…",
  "fis.filtroAperte": "Unpaid",
  "fis.filtroPagate": "Paid",
  "fis.filtroTutte": "All",
  "fis.filtroVoci": "All items",
  "fis.nuova": "New deadline",
  "fis.aggiungi": "Add",
  "fis.colData": "Payment date",
  "fis.colVoce": "Item",
  "fis.colDettaglio": "Detail",
  "fis.colAnno": "Year",
  "fis.colPeriodo": "Period",
  "fis.colImporto": "Amount",
  "fis.colModalita": "Method",
  "fis.colCategoria": "Category",
  "fis.colPagato": "Paid",
  "fis.colNote": "Notes",
  "fis.colTotale": "Total",
  "fis.catRate": "instalments",
  "fis.catCorrente": "current",
  "fis.catFin": "financing",
  "fis.cardTotale": "Tax payable",
  "fis.cardRate": "of which instalments",
  "fis.cardCorrenti": "of which current",
  "fis.cardFin": "Financing (out of tax rows)",
  "fis.cardUltima": "Last deadline",
  "fis.periodoPh": "MAY / II QUARTER / 05/2026-07/2026…",
  "fis.pagatoTip": "Mark paid/unpaid (updates the cash flow)",
  "fis.modificaTip": "Edit this deadline",
  "fis.confermaElimina": "Confirm?",
  "fis.okNuova": "Deadline added",
  "fis.okModifica": "Deadline updated",
  "fis.okElimina": "Deadline deleted",
  "fis.errImporto": "Amount: number greater than zero (e.g. 66.285,24).",
  ...
  "fis.vistaPiani": "Plans",
  "fis.colPiano": "Instalment plan",
  "fis.colRate": "Instalments",
  "fis.colResiduo": "Outstanding",
  "fis.colProssima": "Next instalment",
  "fis.colUltimaRata": "Last instalment",
  "fis.rataN": "Instalment",
  "fis.totaliVoce": "Totals by item (payable / paid)",
  ...
  "stip.importDesc":
    "Upload the payroll consultant's \"COSTI <month>\" file (OneDrive Personale\\MENSILITA'): one row per employee per cost code; the totals row (code 0) carries the total cost. Re-importing a month replaces it.",
  "stip.errTracciato":
  ...
  "stip.nettiBtn": "Import Stipendi Dr (net pay)",
  "stip.nettiTitle": 'Import "Stipendi Dr.xlsx" (net pay per month)',
  "stip.nettiDesc":
    "Upload the Personale\\Stipendi Dr.xlsx file: one sheet per month with STIPENDIO (net due), ANTICIPO (advances already paid) and SALDO (remainder to pay). Each month in the file replaces the one already loaded.",
  "stip.errNetti":
    "No sheet matches the Stipendi Dr layout (needs NOME and STIPENDIO columns, sheet named after the month).",
  "stip.nettiStipendio": "Net due",
  "stip.nettiAnticipi": "Advances",
  "stip.nettiSaldo": "Balance to pay",
  "stip.nettiFlussiCheck":
    'Update the "Stipendi" rows in Cash flow (payment month = month after accrual, amount = balance to pay)',
  "stip.nettiOk": "Net pay imported",
  "stip.nettiMesi": "months",
  "stip.nettiFlussiOk": "Stipendi rows updated in Cash flow",
  "stip.nettiNota": "Net from Stipendi Dr —",
  "stip.nettiCard": "Net payable (Stipendi Dr)",
  "stip.colStip": "Net pay",
  "stip.colAnt": "Advance",
  "stip.colSaldo": "Balance",
  "stip.mappaBtn": "Import staff mapping",
  "stip.mappaTitle": 'Import "Mappatura Dipendenti" (contract data)',
  "stip.mappaDesc":
  ...
  "stip.colMens": "Sal./yr",
  "stip.indet": "Open-ended",
  "stip.det": "Fixed →",
  "stip.nettiVuoto": "Import Stipendi Dr.xlsx to see the net payable.",
  "stip.versato": "Paid out",
  "stip.versatoCol": "Paid out",
  "stip.disposizioni": "payments",
  "stip.nonAbbinate": "not matched to an employee",
  "stip.versatoVuoto":
  ...
  "stip.flussiCheck": 'Update the "Stipendi" row in Cash flow — payment month:',
  "stip.flussiNota": "Personnel cost",
  "stip.flussiOk": "Cash flow updated for",
  "stip.conferma": "Confirm import",
  "stip.importOk": "Payroll imported",
  "stip.eliminato": "Month deleted.",
  "stip.confermaElimina": "Sure? Click again",
  "stip.vsPrec": "vs",
  "stip.oreTot": "Total hours",
  "stip.mediaDip": "Average per employee",
  "stip.oreOrd": "Ord. hrs",
  "stip.oreStr": "Ovt. hrs",
  "stip.ordinario": "Ordinary",
  "stip.straord": "Overtime",
  "stip.ferie": "Leave",
  "stip.mensAgg": "Extra months",
  "stip.totale": "Total",
  "stip.medio": "Avg cost",
  "stip.trend": "Months loaded",
  "stip.vuoto": "No month loaded yet: import the first COSTI file.",
  "fc.titolo": "Cash flow — expected in and out",
  "fc.desc":
    "From the due dates of open invoices (same rules as the Statement), plus the rows invoices don't know about: payroll, taxes, other expenses. Outflows carry a minus sign: paste into Excel and columns add up by themselves.",
  "fc.perMese": "By month",
  "fc.perSettimana": "By week",
  "fc.daData": "from",
  "fc.finoA": "until",
  "fc.nascondiDettaglio": "Hide breakdown",
  "fc.mostraDettaglio": "Show breakdown",
  "fc.esclusioni": "Exclusions",
  "fc.esclDesc":
    "Counterparties kept OUT of this view (non-paying clients, external cash desks) — always, or only for a window of months (from/to, both optional). Tick the boxes and press Exclude: counterparties already excluded disappear from the list.",
  "fc.esclNessuna": "No exclusions.",
  "fc.esclCercaPh": "search counterparty…",
  "fc.esclTutteFuori": "Nothing to show: every matching counterparty is already excluded.",
  "fc.presetDesc":
    "Presets: save the current exclusions under a name and reapply them with one click. Applying a preset replaces the current exclusions.",
  "fc.presetNomePh": "preset name…",
  "fc.presetSalva": "Save preset",
  "fc.presetSalvato": "Preset saved",
  ...
  "fc.saldo": "Balance delta",
  "fc.notaSegni":
    "Outflows are shown negative on purpose: the balance is the plain sum of each column. Manual rows: click a cell, type the amount (minus sign for outflows), Enter. Empty = removes the value.",
  "fc.notaSettimana":
    "Weekly view covers invoices only: manual rows and planned invoicing are monthly and appear in the monthly view.",
  "fc.nuovaVoce": "New manual row:",
  "fc.nuovaVocePh": "e.g. Extraordinary costs",
  "fc.cellaTip": "Click to edit",
  "fc.importoNonValido": "Invalid amount",
  "rt.titolo": "Invoices vs bank statement",
  "rt.estratto": "Bank statement",
  "rt.prevDaFattAtt": "To invoice (planned, active)",
  "rt.prevDaFattPas": "To receive (planned, passive)",
  "rt.prefTitolo": "Pre-invoicing (planned revenue and costs)",
  "rt.prefDesc":
    "Recurring fees and planned invoices that are not issued yet: they show up in the Forecast as italic rows and disappear on their own when the real invoice arrives (same counterpart, same month).",
  "rt.prefDirezione": "Direction",
  "rt.prefAttiva": "Active (to issue)",
  "rt.prefPassiva": "Passive (to receive)",
  "rt.prefMese": "Start month",
  "rt.prefMeseFine": "End month (optional)",
  "rt.prefRicorrenza": "Recurrence",
  "rt.prefMensile": "Monthly",
  "rt.prefUna": "One-off",
  ...
  "rt.prevScaduto": "Overdue",
  "rt.prevIncassi": "To collect",
  "rt.prevPagamenti": "To pay",
  "rt.prevSaldo": "Balance",
  "rt.composizione": "Breakdown",
  "rt.compTot": "total",
  "rt.compNetto": "net",
  "rt.totAttive": "Total active invoices",
  "rt.incassate": "collected",
  "rt.nonIncassate": "outstanding",
  "rt.diCuiRitardo": "of which overdue",
  "rt.daIncassare": "To collect",
  "rt.daPagare": "To pay",
  "rt.differenzaResidui": "Difference",
  "rt.attive": "Active invoices (collected)",
  "rt.passive": "Passive invoices (paid)",
  "rt.differenza": "Difference",
  "rt.netto": "Net invoices",
  "rt.sottotitoloAruba": "Aruba update check",
  "rt.nessunoOpz": "None",
  "rt.estrattoAuto": "Follows Client/Supplier",
  "rt.gruppiBtn": "Saved views",
  "rt.gruppiDesc":
    "Set the three filters as you need (e.g. every Univex company), then save the setup with a name: one click brings it back.",
  "rt.gruppiNomePh": "View name (e.g. UNIVEX)",
  ...
  "rt.esclLabel": "Cash-flow exclusions",
  "rt.esclOff": "Apply exclusions",
  "rt.esclOn": "Exclusions applied",
  "rt.esclHint":
    "Removes from this report the counterparts excluded in the Cash flow tab (same list, same month windows). Off by default: the report stays canonical.",
  "rt.gg": "Delay [days]",
  ...
  "rt.alDataNota":
    "Pick a date (even future): the overdue cards below show what will be due by that day.",
  "rt.elTitolo": "All invoices",
  "rt.elAnno": "Year",
  "rt.elMese": "Month",
  "rt.prTitolo": "What will happen by…",
  "rt.prNota": "Pick a date: invoices due by then, with their outcome.",
  "rt.prAttive": "Sales invoices",
  "rt.prPassive": "Purchase invoices",
  "rt.prDaInc": "To collect",
  "rt.prDaPag": "To pay",
  "rt.prEntro": "by",
  "rt.prPagato": "Paid",
  "rt.elFra": "in",
  "rt.compAttive": "Selected receivables",
  "rt.compPassive": "Selected payables",
  "rt.compTotale": "Document total",
  "rt.compNettoInc": "net to collect",
  "rt.compNettoPag": "net to pay",
  "rt.compSaldo": "Offset:",
  "rt.compSvuota": "Clear selection",
  "fin.regolaAltreSpese": "Counts as Other expenses",
  "fin.regolaAltreSpeseTip":
  ...
  "fin.skippedEraApi": "skipped (bank-sync era: after the cutoff date only the API writes)",
  ...
  "fin.vocNuova": "➕ New value…",
  "fin.regolaSottocat": "Set subcategory",
  "fin.regolaFraseSottocat": "subcategory →",
  "fin.sottocat": "Subcategory",
  "fin.regolaAllocPri": "Set primary allocation",
  "fin.regolaAllocSec": "Set secondary allocation",
  "fin.allocPri": "Primary allocation",
  ...
  "fin.selN": "selected",
  "fin.selCorreggi": "Bulk edit",
  "fin.selDeselez": "Clear selection",
  "fin.selElimina": "Delete selected",
  "fin.selEliminaConfirm":
    "Delete the selected rules? Movements already classified stay as they are.",
  "fin.selFatto": "Done",
  "fin.selVuotoNonCambia": "Fields left empty are NOT touched.",
  "fin.selNonCambiare": "(do not change)",
  "ft.selClassifica": "Bulk classify",
  "fin.rangeDate": "Date from → to",
  "fin.rangeImporti": "Amount from → to",
  "fin.rangeMin": "min",
  "fin.rangeMax": "max",
  "fin.regoleEsporta": "Export for Excel (CSV)",
  "fin.uniBtn": "Merge duplicates",
  "fin.uniNiente": "No duplicate rules to merge",
  "fin.uniConfirm1": "Merging",
  "fin.uniConfirm2": "groups of equivalent rules (removing",
  "fin.uniConfirm3": "rules) and cleaning duplicate terms in",
  "fin.uniConfirm4": "more rules. Proceed?",
  "fin.uniFatto": "Rules merged",
  ...
  "fin.distRighe": "payment rows",
  "fin.distGia": "already stored",
  "fin.distImporta": "Import",
  "fin.distEsitoOk": "Batch details imported",
  "fin.distNoRighe": "No payment rows recognized in this file",
  "fin.distArchivio": "rows stored in the archive",
  "fin.distBadgeTip": "Bulk payment: click to see the beneficiaries",
  ...
  "fin.soloNonClass": "Unclassified only",
  "fin.perPagina": "Rows per page",
  "fin.distAggFuturo": "Future date: the debit has not happened yet — it will link by itself.",
  "fin.distAggNessunMov": "No bank transactions within ±15 days: run the bank sync first.",
  ...
  "fin.spiegaNessuna":
    "No rule matches: technical ABI type, manual value, or unclassified (Anomalie).",
  "fin.conto": "Account",
  ...
  "fin.regolaImpattoND":
    "The transaction archive is still loading, so the impact cannot be estimated yet. Save the rule anyway?",
  ...
  "ft.arDiagTitolo": "Aruba diagnostics (invoicing API)",
  "ft.arDiagDesc":
  ...
  "ft.arIncassi": "Test payments API",
  "ft.arIncFile": "File name (optional)",
  "ft.arSyncGiorni": "Days back",
  "ft.arSyncFinestra": "Window",
  "ft.arSyncLotti": "batches found",
  "ft.arSyncNuovi": "new",
  "ft.arSyncImportate": "imported",
  "ft.arSyncAggiornate": "updated",
  ...
  "ft.meseRegola": "Month when not in text",
  "ft.meseRegolaTip":
    "Fallback rule for the accrual month when it is not written in the invoice text.",
  "ft.meseRegolaG15": "Day-15 rule (standard)",
  "ft.meseRegolaSucc": "Month after issue date",
  "ft.meseRegolaCorr": "Issue month",
  "ft.colCompetenza": "Accrual month",
  "ft.colTipologia": "Cost type",
  "ft.colClienteRif": "Ref. client",
  "ft.colServizio": "Service",
  "ft.rfTitolo": "Classification rules",
  "ft.rfClienteInclude": "If customer/supplier includes (comma-separated terms)",
  "ft.rfOggettoInclude": "If subject or description includes",
  "ft.rfNonImpostare": "(do not set)",
  "ft.cx": "Complete from XML",
  "ft.cxTip":
    "For invoices in view with no subject/description: re-downloads the XML via the Aruba API and fills subject, description, declared due date and missing taxable base.",
  "ft.cxNessuna": "Nothing to complete: every invoice in view already has its description.",
  ...
  "ft.colIva": "VAT",
  "ft.pvImporti": "Amounts:",
  "ft.pvTotale": "Total (VAT incl.)",
  "ft.pvImponibile": "Taxable base (no VAT)",
  "ft.rfSalvata": "Invoice rule saved",
  "ft.rfDelConfirm": "Delete this rule? Already saved classifications stay.",
  "ft.rfFraseCliente": "If customer includes",
  "ft.rfFraseOggetto": "if subject/description includes",
  "ft.colTipoDoc": "Doc type",
  "ft.colDaIncassareNetto": "To collect (tot-coll.)",
  "ft.colDaPagareNetto": "To pay (tot-paid)",
  "ft.colDataIncasso": "Collection date",
  "ft.colDataPagamento": "Payment date",
  ...
  "fin.tabPivot": "Pivot",
  "fin.pivotAnno": "Year",
  "fin.pivotFw": "Fiscal week",
  "fin.forzatiIncasso": "positives forced to Incoming",
  "fin.riapplForza": "forcing incoming on positives\u2026",
  "fin.riapplAnalisi": "analysis in progress\u2026",
  "fin.riapplRimanenti": "remaining",
  "fin.riapplFatto": "Re-application finished",
  "fin.pivotPulisciFiltri": "Clear pivot filters",
  "fin.pivotComprimi": "Collapse all",
  "fin.pivotEspandi": "Expand all",
  "fin.regTabMov": "Movement rules",
  "fin.regTabFat": "Invoice rules",
  "fin.rfDoveImport":
    "The Excel rules import lives in the Invoices tab, inside the same rules panel.",
  ...
  "ft.rfImpDoppie": "already present or duplicated",
  "ft.rfImpBtn": "Create rules",
  "ft.rfImpOk": "Rules imported",
  "ft.rfImpNiente": "No rule sheet recognized in this file.",
  ...
  "ft.salutePrimaNota": "Cash entries:",
  "ft.saluteStati": "Payment states:",
  "ft.classTipVuota": "— from rule —",
  ...
  "ft.collegaA": "Link credit note to invoice",
  "ft.fNc": "Credit notes",
  "ft.fNcSciolte": "Credit notes to link",
...
const it: Record<DictKey, string> = {
  ...
  "gt.turnoTroppoLungo":
    "Il turno supera le 24 ore: controlla gli orari (un orario che torna indietro rispetto al passo precedente vale come giorno dopo).",
  ...
  "login.pinDimenticato": "PIN dimenticato? Cambialo con l'email",
  "cp.title": "Cambia PIN",
  "cp.sub1":
    "Scrivi il tuo codice dipendente: mandiamo un codice di verifica all'email registrata in ufficio.",
  "cp.sub2": "Inserisci le 6 cifre ricevute per email e scegli il PIN nuovo.",
  "cp.mandami": "Mandami il codice",
  "cp.invio": "Un attimo…",
  "cp.inviata":
    "Se è tutto a posto, il codice sta arrivando a {email}. Vale 15 minuti — controlla anche lo spam.",
  "cp.forse":
    "Se il codice esiste e ha un'email registrata, il codice di verifica sta arrivando. Vale 15 minuti.",
  "cp.otpPlaceholder": "Codice di verifica (6 cifre)",
  "cp.pinNuovo": "PIN nuovo (4-8 cifre)",
  "cp.pinRipeti": "Ripeti il PIN nuovo",
  "cp.pinDiversi": "I due PIN non coincidono.",
  "cp.cambia": "Cambia il PIN",
  "cp.rimanda": "Codice sbagliato o non arrivato? Ricomincia",
  "cp.tornaLogin": "Torna all'accesso",
  "cp.nota": "Non hai un'email registrata? Chiedi in ufficio di registrarla, poi riprova.",
  "cp.fatto": "PIN cambiato — accedi con quello nuovo.",
  "cp.errGenerico": "Qualcosa è andato storto. Riprova.",
  "login.hero":
  ...
  "common.print": "Stampa",
  "common.printTip": "Stampa solo questo riepilogo (menù, filtri e bottoni restano fuori)",
  "common.open": "apri",
  ...
  "presenze.saving": "Registrazione…",
  "presenze.quickMyHours": "Le mie ore",
  "presenze.quickMyHoursDesc": "I turni del mese e le correzioni",
  "presenze.quickManual": "Manuale",
  "presenze.quickManualDesc": "Come funziona il portale",
  "presenze.quickPin": "Cambia PIN",
  "presenze.quickPinDesc": "Con il codice via email",
  ...
  "gt.scarta": "Scarta",
  "gt.scartataOk": "Anomalia scartata.",
  "gt.ferieBadge": "Ferie",
  ...
  "fin.tabFlussi": "Flussi di cassa",
  "fin.tabStipendi": "Stipendi",
  "fin.tabFiscale": "Fiscale",
  "fis.titolo": "Scadenziario fiscale",
  "fis.desc":
    "Lo scadenziario di Sabrina, compilabile direttamente qui: scadenze, pivot Da pagare e Pagato, export CSV di ogni vista. Le voci 'Costo fiscale' dei Flussi leggono questi stessi dati. L'import dell'Excel (pannello nei Flussi) resta per la transizione: sostituisce le righe DA FILE e conserva quelle create o modificate sul portale.",
  "fis.fonte": "Ultimo file importato:",
  "fis.vistaScadenze": "Scadenze",
  "fis.vistaDaPagare": "Da pagare",
  "fis.vistaPagato": "Pagato",
  "fis.cercaPh": "Cerca voce, dettaglio, note…",
  "fis.filtroAperte": "Da pagare",
  "fis.filtroPagate": "Pagate",
  "fis.filtroTutte": "Tutte",
  "fis.filtroVoci": "Tutte le voci",
  "fis.nuova": "Nuova scadenza",
  "fis.aggiungi": "Aggiungi",
  "fis.colData": "Data pagamento",
  "fis.colVoce": "Voce",
  "fis.colDettaglio": "Dettaglio",
  "fis.colAnno": "Anno",
  "fis.colPeriodo": "Periodo",
  "fis.colImporto": "Importo",
  "fis.colModalita": "Modalità",
  "fis.colCategoria": "Categoria",
  "fis.colPagato": "Pagata",
  "fis.colNote": "Note",
  "fis.colTotale": "Totale",
  "fis.catRate": "rate",
  "fis.catCorrente": "corrente",
  "fis.catFin": "finanziamento",
  "fis.cardTotale": "Fiscale da pagare",
  "fis.cardRate": "di cui rate",
  "fis.cardCorrenti": "di cui correnti",
  "fis.cardFin": "Finanziamenti (fuori voci fiscali)",
  "fis.cardUltima": "Ultima scadenza",
  "fis.periodoPh": "MAGGIO / II TRIMESTRE / 05/2026-07/2026…",
  "fis.pagatoTip": "Segna pagata/da pagare (aggiorna il cash flow)",
  "fis.modificaTip": "Modifica questa scadenza",
  "fis.confermaElimina": "Confermi?",
  "fis.okNuova": "Scadenza aggiunta",
  "fis.okModifica": "Scadenza aggiornata",
  "fis.okElimina": "Scadenza eliminata",
  "fis.errImporto": "Importo: numero maggiore di zero (es. 66.285,24).",
  ...
  "fis.vistaPiani": "Piani",
  "fis.colPiano": "Piano di rateizzo",
  "fis.colRate": "Rate",
  "fis.colResiduo": "Residuo",
  "fis.colProssima": "Prossima rata",
  "fis.colUltimaRata": "Ultima rata",
  "fis.rataN": "Rata",
  "fis.totaliVoce": "Totali per voce (da pagare / pagato)",
  ...
  "stip.importDesc":
    'Carica il file "COSTI <mese>" del consulente paghe (OneDrive Personale\\MENSILITA\'): una riga per dipendente per codice di costo; la riga Totalizzazioni (codice 0) porta il totale costo. Ricaricare un mese lo sostituisce.',
  "stip.errTracciato":
  ...
  "stip.nettiBtn": "Importa Stipendi Dr (netti)",
  "stip.nettiTitle": 'Importa "Stipendi Dr.xlsx" (netti del mese)',
  "stip.nettiDesc":
    "Carica il file Personale\\Stipendi Dr.xlsx: un foglio per mese con STIPENDIO (netto dovuto), ANTICIPO (acconti già versati) e SALDO (resto da pagare). Ogni mese presente nel file sostituisce quello già caricato.",
  "stip.errNetti":
    "Nessun foglio rispetta il tracciato Stipendi Dr (servono le colonne NOME e STIPENDIO, foglio col nome del mese).",
  "stip.nettiStipendio": "Netto dovuto",
  "stip.nettiAnticipi": "Anticipi",
  "stip.nettiSaldo": "Saldo da pagare",
  "stip.nettiFlussiCheck":
    'Aggiorna le righe "Stipendi" nei Flussi di cassa (mese pagamento = successivo alla competenza, importo = saldo da pagare)',
  "stip.nettiOk": "Netti importati",
  "stip.nettiMesi": "mesi",
  "stip.nettiFlussiOk": "righe Stipendi aggiornate nei Flussi",
  "stip.nettiNota": "Netto da Stipendi Dr —",
  "stip.nettiCard": "Netto da pagare (Stipendi Dr)",
  "stip.colStip": "Stipendio",
  "stip.colAnt": "Anticipo",
  "stip.colSaldo": "Saldo",
  "stip.mappaBtn": "Importa mappatura (contratti)",
  "stip.mappaTitle": 'Importa "Mappatura Dipendenti" (dati contrattuali)',
  "stip.mappaDesc":
    "Carica Personale\\DIPENDENTI\\Mappatura Dipendenti Dr Logistica.xlsx: mansione (col livello contrattuale), data fine o indeterminato, orario. Sostituisce la mappatura salvata; l'abbinamento ai dipendenti è per nome.",
  "stip.errMappa":
  ...
  "stip.colMens": "Mens.",
  "stip.indet": "Indeterminato",
  "stip.det": "Det. →",
  "stip.nettiVuoto": "Importa Stipendi Dr.xlsx per vedere il netto da pagare.",
  "stip.versato": "Versato in banca",
  "stip.versatoCol": "Versato",
  "stip.disposizioni": "disposizioni",
  "stip.nonAbbinate": "non abbinate a un dipendente",
  "stip.versatoVuoto":
  ...
  "stip.flussiCheck": 'Aggiorna la riga "Stipendi" nei Flussi di cassa — mese di pagamento:',
  "stip.flussiNota": "Costo del personale",
  "stip.flussiOk": "Flussi aggiornati per",
  "stip.conferma": "Conferma import",
  "stip.importOk": "Stipendi importati",
  "stip.eliminato": "Mese eliminato.",
  "stip.confermaElimina": "Sicuro? Clicca di nuovo",
  "stip.vsPrec": "vs",
  "stip.oreTot": "Ore totali",
  "stip.mediaDip": "Media per dipendente",
  "stip.oreOrd": "Ore ord.",
  "stip.oreStr": "Ore str.",
  "stip.ordinario": "Ordinario",
  "stip.straord": "Straordinari",
  "stip.ferie": "Ferie/Perm.",
  "stip.mensAgg": "Mens. agg.",
  "stip.totale": "Totale",
  "stip.medio": "Costo medio",
  "stip.trend": "Mesi caricati",
  "stip.vuoto": "Nessun mese ancora caricato: importa il primo file COSTI.",
  "fc.titolo": "Flussi di cassa — entrate e uscite attese",
  "fc.desc":
    "Dalle scadenze delle fatture aperte (stesse regole del Resoconto), più le righe che le fatture non conoscono: stipendi, costo fiscale, altre spese. Le uscite hanno il segno meno: incollando in Excel le colonne si sommano da sole.",
  "fc.perMese": "Per mese",
  "fc.perSettimana": "Per settimana",
  "fc.daData": "dal",
  "fc.finoA": "fino al",
  "fc.nascondiDettaglio": "Nascondi dettaglio",
  "fc.mostraDettaglio": "Mostra dettaglio",
  "fc.esclusioni": "Esclusioni",
  "fc.esclDesc":
    "Controparti tenute FUORI da questa vista (clienti che non pagano, casse esterne) — sempre, o solo per una finestra di mesi (da/a, entrambi facoltativi). Metti la spunta e premi Escludi: le controparti già escluse spariscono dall'elenco.",
  "fc.esclNessuna": "Nessuna esclusione.",
  "fc.esclCercaPh": "cerca controparte…",
  "fc.esclTutteFuori": "Niente da mostrare: le controparti corrispondenti sono già tutte escluse.",
  "fc.presetDesc":
    "Preset: salva le esclusioni attuali con un nome e riapplicale con un click. Applicare un preset sostituisce le esclusioni correnti.",
  "fc.presetNomePh": "nome del preset…",
  "fc.presetSalva": "Salva preset",
  "fc.presetSalvato": "Preset salvato",
  ...
  "fc.saldo": "Delta saldo",
  "fc.notaSegni":
    "Le uscite sono in negativo apposta: il saldo è la somma semplice di ogni colonna. Righe manuali: clic sulla cella, importo (col meno per le uscite), Invio. Vuoto = toglie il valore.",
  "fc.notaSettimana":
    "La vista per settimana copre solo le fatture: righe manuali e prefatturazione sono mensili e compaiono nella vista per mese.",
  "fc.nuovaVoce": "Nuova riga manuale:",
  "fc.nuovaVocePh": "es. Costi straordinari",
  "fc.cellaTip": "Clic per modificare",
  "fc.importoNonValido": "Importo non valido",
  "rt.titolo": "Situazione fatture vs Estratto conto",
  "rt.estratto": "Estratto conto",
  "rt.prevDaFattAtt": "Da fatturare (pianificato, attive)",
  "rt.prevDaFattPas": "Da ricevere (pianificato, passive)",
  "rt.prefTitolo": "Prefatturazione (ricavi e costi pianificati)",
  "rt.prefDesc":
    "Canoni ricorrenti e fatture pianificate non ancora emesse: entrano nella Previsione come righe in corsivo e spariscono da sole quando arriva la fattura vera (stessa controparte, stesso mese).",
  "rt.prefDirezione": "Direzione",
  "rt.prefAttiva": "Attiva (da emettere)",
  "rt.prefPassiva": "Passiva (da ricevere)",
  "rt.prefMese": "Mese di inizio",
  "rt.prefMeseFine": "Mese di fine (facolt.)",
  "rt.prefRicorrenza": "Ricorrenza",
  "rt.prefMensile": "Mensile",
  "rt.prefUna": "Una tantum",
  ...
  "rt.prevScaduto": "Scaduto",
  "rt.prevIncassi": "Da incassare",
  "rt.prevPagamenti": "Da pagare",
  "rt.prevSaldo": "Saldo",
  "rt.composizione": "Composizione",
  "rt.compTot": "tot",
  "rt.compNetto": "netto",
  "rt.totAttive": "Totale fatture attive",
  "rt.incassate": "incassate",
  "rt.nonIncassate": "da incassare",
  "rt.diCuiRitardo": "di cui in ritardo",
  "rt.daIncassare": "Da incassare",
  "rt.daPagare": "Da pagare",
  "rt.differenzaResidui": "Differenza",
  "rt.attive": "Fatture attive (incassato)",
  "rt.passive": "Fatture passive (pagato)",
  "rt.differenza": "Differenza",
  "rt.netto": "Netto fatture",
  "rt.sottotitoloAruba": "Controllo aggiornamento Aruba",
  "rt.nessunoOpz": "Nessuno",
  "rt.estrattoAuto": "Segue Cliente/Fornitore",
  "rt.gruppiBtn": "Viste salvate",
  "rt.gruppiDesc":
    "Imposta i tre filtri come ti servono (es. tutte le società Univex), poi salva la configurazione con un nome: un click e la ritrovi.",
  "rt.gruppiNomePh": "Nome della vista (es. UNIVEX)",
  ...
  "rt.esclLabel": "Esclusioni dei Flussi",
  "rt.esclOff": "Applica esclusioni",
  "rt.esclOn": "Esclusioni applicate",
  "rt.esclHint":
    "Toglie da questo quadro le controparti escluse nella tab Flussi di cassa (stessa lista, stesse finestre di mesi). Spento di default: il quadro resta canonico.",
  "rt.gg": "Ritardo [gg]",
  ...
  "rt.alDataNota":
    "Scegli una data (anche futura): le card dei ritardi qui sotto mostrano cosa sarà scaduto entro quel giorno.",
  "rt.elTitolo": "Tutte le fatture",
  "rt.elAnno": "Anno",
  "rt.elMese": "Mese",
  "rt.prTitolo": "Cosa succederà entro il…",
  "rt.prNota": "Scegli una data: le fatture in scadenza entro quel giorno, con il loro esito.",
  "rt.prAttive": "Fatture attive",
  "rt.prPassive": "Fatture passive",
  "rt.prDaInc": "Da incassare",
  "rt.prDaPag": "Da pagare",
  "rt.prEntro": "entro il",
  "rt.prPagato": "Pagato",
  "rt.elFra": "fra",
  "rt.compAttive": "Attive selezionate",
  "rt.compPassive": "Passive selezionate",
  "rt.compTotale": "Totale documento",
  "rt.compNettoInc": "netto a incassare",
  "rt.compNettoPag": "netto a pagare",
  "rt.compSaldo": "Compensazione:",
  "rt.compSvuota": "Svuota selezione",
  "fin.regolaAltreSpese": "Conta nelle Altre spese",
  "fin.regolaAltreSpeseTip":
  ...
  "fin.skippedEraApi": "scartate (era del sync bancario: dal taglio in poi scrive solo l'API)",
  ...
  "fin.vocNuova": "➕ Nuova voce…",
  "fin.regolaSottocat": "Imposta sottocategoria",
  "fin.regolaFraseSottocat": "sottocategoria →",
  "fin.sottocat": "Sottocategoria",
  "fin.regolaAllocPri": "Imposta allocazione primaria",
  "fin.regolaAllocSec": "Imposta allocazione secondaria",
  "fin.allocPri": "Allocazione primaria",
  ...
  "fin.selCorreggi": "Correggi selezionati",
  "fin.selDeselez": "Deseleziona",
  "fin.selElimina": "Elimina selezionate",
  "fin.selEliminaConfirm":
    "Eliminare le regole selezionate? I movimenti già classificati restano come sono.",
  "fin.selFatto": "Fatto",
  "fin.selVuotoNonCambia": "I campi lasciati vuoti NON vengono toccati.",
  "fin.selNonCambiare": "(non cambiare)",
  "ft.selClassifica": "Classifica selezionate",
  "fin.rangeDate": "Data dal → al",
  "fin.rangeImporti": "Importo da → a",
  "fin.rangeMin": "min",
  "fin.rangeMax": "max",
  "fin.regoleEsporta": "Esporta per Excel (CSV)",
  "fin.uniBtn": "Unifica doppie",
  "fin.uniNiente": "Nessuna regola doppia da unificare",
  "fin.uniConfirm1": "Verranno uniti",
  "fin.uniConfirm2": "gruppi di regole equivalenti (eliminando",
  "fin.uniConfirm3": "regole) e ripuliti i termini doppi in altre",
  "fin.uniConfirm4": "regole. Procedere?",
  "fin.uniFatto": "Regole unificate",
  ...
  "fin.distRighe": "disposizioni",
  "fin.distGia": "gi\u00e0 presenti",
  "fin.distImporta": "Importa",
  "fin.distEsitoOk": "Dettaglio distinte importato",
  "fin.distNoRighe": "Nessuna disposizione riconosciuta nel file",
  "fin.distArchivio": "disposizioni in archivio",
  "fin.distBadgeTip": "Pagamento cumulativo: clic per vedere i beneficiari",
  ...
  "fin.soloNonClass": "Solo non classificate",
  "fin.perPagina": "Righe per pagina",
  "fin.distAggFuturo": "Data futura: l’addebito non è ancora avvenuto — si aggancerà da solo.",
  "fin.distAggNessunMov": "Nessun movimento bancario nei ±15 giorni: sincronizzare prima la banca.",
  ...
  "fin.spiegaNessuna":
    "Nessuna regola combacia: tipologia tecnica ABI, valore inserito a mano, oppure non classificato (Anomalie).",
  "fin.conto": "Conto",
  ...
  "fin.regolaImpattoND":
    "L'archivio movimenti è ancora in caricamento: impossibile stimare l'impatto. Salvare comunque la regola?",
  ...
  "ft.arDiagTitolo": "Diagnostica Aruba (API fatturazione)",
  "ft.arDiagDesc":
  ...
  "ft.arIncassi": "Prova API incassi",
  "ft.arIncFile": "Nome file (facoltativo)",
  "ft.arSyncGiorni": "Giorni indietro",
  "ft.arSyncFinestra": "Finestra",
  "ft.arSyncLotti": "lotti trovati",
  "ft.arSyncNuovi": "nuovi",
  "ft.arSyncImportate": "importate",
  "ft.arSyncAggiornate": "aggiornate",
  ...
  "ft.meseRegola": "Mese se non nel testo",
  "ft.meseRegolaTip":
    "Regola di ripiego per il mese di competenza quando non è scritto nel testo della fattura.",
  "ft.meseRegolaG15": "Regola del giorno 15 (standard)",
  "ft.meseRegolaSucc": "Mese successivo all'emissione",
  "ft.meseRegolaCorr": "Mese di emissione",
  "ft.colCompetenza": "Competenza",
  "ft.colTipologia": "Tipologia",
  "ft.colClienteRif": "Cliente rif",
  "ft.colServizio": "Servizio",
  "ft.rfTitolo": "Regole di classificazione",
  "ft.rfClienteInclude": "Se cliente/fornitore include (termini separati da virgola)",
  "ft.rfOggettoInclude": "Se oggetto o descrizione include",
  "ft.rfNonImpostare": "(non impostare)",
  "ft.cx": "Completa dagli XML",
  "ft.cxTip":
    "Per le fatture in vista senza oggetto/descrizione: riscarica l’XML via API Aruba e riempie oggetto, descrizione, scadenza dichiarata e imponibile mancante.",
  "ft.cxNessuna": "Niente da completare: tutte le fatture in vista hanno già la descrizione.",
  ...
  "ft.colIva": "IVA",
  "ft.pvImporti": "Importi:",
  "ft.pvTotale": "Totale (con IVA)",
  "ft.pvImponibile": "Imponibile (senza IVA)",
  "ft.rfSalvata": "Regola fatture salvata",
  "ft.rfDelConfirm": "Eliminare questa regola? Le classificazioni già salvate restano.",
  "ft.rfFraseCliente": "Se il cliente include",
  "ft.rfFraseOggetto": "se oggetto/descrizione include",
  "ft.colTipoDoc": "Tipo doc",
  "ft.colDaIncassareNetto": "Da incassare (tot-inc)",
  "ft.colDaPagareNetto": "Da pagare (tot-pag)",
  "ft.colDataIncasso": "Data incasso",
  "ft.colDataPagamento": "Data pagamento",
  ...
  "fin.pivotAnno": "Anno",
  "fin.pivotFw": "Fiscal week",
  "fin.forzatiIncasso": "positivi convertiti d\u2019ufficio a Incasso",
  "fin.riapplForza": "conversione incassi sui positivi\u2026",
  "fin.riapplAnalisi": "analisi in corso\u2026",
  "fin.riapplRimanenti": "rimanenti",
  "fin.riapplFatto": "Riapplicazione completata",
  "fin.pivotPulisciFiltri": "Pulisci filtri pivot",
  "fin.pivotComprimi": "Comprimi tutto",
  "fin.pivotEspandi": "Espandi tutto",
  "fin.regTabMov": "Regole movimenti",
  "fin.regTabFat": "Regole fatture",
  "fin.rfDoveImport":
    "L\u2019import delle regole da Excel si trova nella tab Fatture, dentro lo stesso pannello regole.",
  ...
  "ft.rfImpDoppie": "gi\u00e0 presenti o duplicate",
  "ft.rfImpBtn": "Crea le regole",
  "ft.rfImpOk": "Regole importate",
  "ft.rfImpNiente": "Nessun foglio di regole riconosciuto in questo file.",
  ...
  "ft.salutePrimaNota": "Prima nota:",
  "ft.saluteStati": "Stati pagamento:",
  "ft.classTipVuota": "— dalla regola —",
  ...
  "ft.collegaA": "Collega la nota di credito alla fattura",
  "ft.fNc": "Note di credito",
  "ft.fNcSciolte": "NC da collegare",
