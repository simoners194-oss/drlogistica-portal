...
const en = {
  ...
  "ft.import": "Import",
  "ft.importTitle": "Import from Aruba export (xlsx)",
  "ft.importDesc":
    "Upload the invoice export from the Aruba panel (or the director's file). Rows are keyed by the SdI file name: re-importing never duplicates and updates the SdI status.",
...
const it: Record<DictKey, string> = {
  ...
  "ft.import": "Importa",
  "ft.importTitle": "Importa dall'export Aruba (xlsx)",
  "ft.importDesc":
    "Carica l'export fatture del pannello Aruba (o il file del direttore). Le righe sono identificate dal nome file SdI: reimportare non duplica mai e aggiorna lo stato SdI.",
