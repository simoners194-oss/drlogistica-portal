...
const en = {
  ...
  "fc.autoTip": "Automatic average of the last 2 months (rules flagged with €). Click to type a manual value.",
...
const it: Record<DictKey, string> = {
  ...
  "fc.autoTip": "Media automatica degli ultimi 2 mesi (regole flaggate con €). Clicca per scrivere un valore manuale.",
