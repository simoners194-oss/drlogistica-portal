...
const en = {
  ...
  "fc.esclDesc":
    "Counterparties kept OUT of this view (non-paying clients, external cash desks) — always, or only for a window of months (from/to, both optional). Name matching works like rules: 'contains'.",
  "fc.esclNessuna": "No exclusions.",
  "fc.esclNomePh": "counterparty name (contains)…",
...
const it: Record<DictKey, string> = {
  ...
  "fc.esclDesc":
    "Controparti tenute FUORI da questa vista (clienti che non pagano, casse esterne) — sempre, o solo per una finestra di mesi (da/a, entrambi facoltativi). Il nome si confronta come nelle regole: 'contiene'.",
  "fc.esclNessuna": "Nessuna esclusione.",
  "fc.esclNomePh": "nome controparte (contiene)…",
